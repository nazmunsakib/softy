...
const Hero = () => {
    return (
        <section className="hero-aria container min-h-[600px] flex flex-col justify-center">
            <div className="hero-info">
                <h1 className='font-bold font-dmsans text-7xl text-[#10172b]'><span className='underline'>Nazmun</span> Sakib</h1>
                <h2 className='font-bold font-dmsans text-6xl mt-2 text-[#10172b]'>Create things for the web!</h2>
