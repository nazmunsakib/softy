        ...
        <section id="home" className="hero-aria min-h-screen flex flex-col justify-center pt-14 relative">
           ...
           <div className="container">
                <div className="hero-info md:w-2/3">
                    ...
                    <Link to="contact-me" className="capitalize text-primary border-[1px] inline-block mt-5 rounded px-7 py-3 hover:text-secondary transition-all duration-100" spy={true} smooth={true} duration={1000} >Get in touch</Link>
                </div>
           </div>
        </section>
    );
