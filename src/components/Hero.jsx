        ...
        <section id="home" className="hero-aria min-h-screen flex flex-col justify-center pt-14 relative">
           ...
           <div className="container">
                <div className="hero-info md:w-2/3">
                    ...
                    <p className='md:text-lg mt-2 md:mt-4 font-poppins'>I m a software developer specializing in creating modern websites, applications, WordPress plugins, and everything in between.</p>
