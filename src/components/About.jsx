            ...
            <div className="container">
                <div className="about-content flex flex-col-reverse md:flex-row">
                    ...
                    <div className="info-area w-full md:w-2/3 md:pl-16 mb-7">
                        ...
                        <a href="https://nazmunsakib.com/sakib-resume.pdf" className="bg-primary px-5 py-2 rounded hover:bg-softySolid shadow-softy2 inline-block mt-7 text-white font-semibold capitalize" target="_blank" rel="noopener noreferrer">Get Resume</a>
                    </div>
                </div>
            </div>
        </section>
